...
<head>
    ...
    <title><?php echo e($lead->type === 'waitlist' ? 'Waitlist confirmation' : 'Contact confirmation'); ?></title>
</head>
                                    ...
                                    <table role="presentation" cellpadding="0" cellspacing="0" width="100%" style="border-collapse:separate;border-spacing:0;margin:0 0 18px 0;background-color:#ffffff;border:1px solid #006386;border-radius:8px;">
                                        <tr>
                                            <td style="padding:14px 16px;">
                                                ...
                                                <p style="margin:0 0 8px 0;font-size:17px;font-weight:800;letter-spacing:-0.02em;line-height:1.35;color:#1c1c19;"><?php echo e($launchPhrase); ?></p>
                                                <p style="margin:0;font-size:13px;line-height:1.5;color:#3f484e;"><strong style="color:#1c1c19;">Target:</strong> <?php echo e($launchAtFormatted); ?></p>
                                            </td>
                                        </tr>
                                    </table>
                                <?php else: ?>
...
<?php /**PATH /Users/mexpower/Sites/df-publisher-landing/resources/views/emails/marketplace/lead-confirmation.blade.php ENDPATH**/ ?>