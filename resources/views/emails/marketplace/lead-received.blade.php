...
<head>
    ...
    <title>New {{ ucfirst($lead->type) }} Lead</title>
</head>
                ...
                <table role="presentation" cellpadding="0" cellspacing="0" width="100%" style="max-width:560px;border-collapse:separate;border-spacing:0;background-color:#ffffff;border:1px solid #bec8cf;border-radius:10px;overflow:hidden;">
                    ...
                    <tr>
                        <td style="padding:26px 26px 8px 26px;background-color:#ffffff;">
                            <h1 style="margin:0 0 22px 0;font-size:22px;font-weight:800;letter-spacing:-0.03em;line-height:1.15;color:#1c1c19;">New {{ ucfirst($lead->type) }} Lead</h1>
                            ...
                            <table role="presentation" cellpadding="0" cellspacing="0" width="100%" style="border-collapse:separate;border-spacing:0;background-color:#f6f3ee;border:1px solid #bec8cf;border-radius:8px;margin-bottom:22px;">
                                ...
                                <tr>
                                    <td style="padding:14px 16px;border-bottom:{{ $lead->type === 'contact' ? '1px solid #e5ded4' : 'none' }};">
                                    ...
                                    @if($lead->name)
                                        <tr>
                                            <td style="padding:14px 16px;border-bottom:1px solid #e5ded4;">
                                                ...
                                                <span style="display:block;margin-top:4px;font-size:15px;font-weight:600;color:#1c1c19;">{{ $lead->name }}</span>
                                            </td>
                                        </tr>
                                    @endif
                                    @if($lead->company)
                                ...
                                <table role="presentation" cellpadding="0" cellspacing="0" width="100%" style="border-collapse:separate;border-spacing:0;background-color:#f6f3ee;border:1px solid #bec8cf;border-radius:8px;">
                                    ...
                                    <tr>
                                        <td style="padding:14px 16px;border-bottom:1px solid #e5ded4;">
                                            ...
                                            <span style="display:block;margin-top:4px;font-size:15px;font-weight:600;color:#1c1c19;">{{ $lead->ip_address }}</span>
                                        </td>
                                    </tr>
                                    @endif
                                    @if($lead->device)
                                    <tr>
                                        <td style="padding:14px 16px;border-bottom:1px solid #e5ded4;">
                                            ...
                                            <span style="display:block;margin-top:4px;font-size:15px;font-weight:600;color:#1c1c19;">{{ $lead->device }}</span>
                                        </td>
                                    </tr>
                                    @endif
                                    ...
                                    <tr>
                                        <td style="padding:14px 16px;border-bottom:1px solid #e5ded4;">
                                            ...
                                            <span style="display:block;margin-top:4px;font-size:15px;font-weight:600;color:#1c1c19;">{{ $lead->operating_system }}</span>
                                        </td>
                                    </tr>
                                    @endif
                                    ...
                                    <tr>
                                        <td style="padding:14px 16px;">
                                            ...
                                            <span style="display:block;margin-top:4px;font-size:15px;font-weight:600;color:#1c1c19;">{{ collect([$lead->city, $lead->region, $lead->country, $lead->country_code])->filter()->implode(', ') }}</span>
                                        </td>
                                    </tr>
                                    @endif
                                </table>
                    ...
                    <tr>
                        <td style="padding:16px 26px;background-color:#fcf9f3;border-top:1px solid #bec8cf;">
                            <p style="margin:0;font-size:11px;line-height:1.5;color:#6f787f;">Created: {{ $lead->created_at?->toDayDateTimeString() }}</p>
                        </td>
                    </tr>
                </table>
            </td>
